    ...
    <>
      ...
      <div className="flex flex-col w-full h-full min-h-screen bg-black px-14">
        ...
        >
          ...
          <p className="text-white text-xl text-left mt-20 opacity-50">
            Junior freelance developer skilled in React, HTML, CSS, and
            JavaScript. Committed to <br></br> delivering high-quality projects
            with efficiency and creativity.
          </p>
          <button
            class="  mt-5 bg-emerald-500 w-[150px] h-[41px]  font-semibold 
         rounded-[10px]
         text-white"
          >
            About Me
        ...
        <section id="about" className="w-full h-full min-h-screen bg-black">
          <img src="me"></img>
          <p className="text-white">
            ...
            dedicating time to sports and physical activities. Join me as I
            combine my technical expertise and creative vision to build
            exceptional online experiences. Let's embark on an exciting journey
            together!
          </p>
        </section>
